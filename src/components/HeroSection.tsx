...
export const HeroSection = () => {
  return (
    <section className="relative h-screen flex flex-col overflow-hidden bg-url('/banner-bg1.jpg')">
      {/* Background Cloud Tunnel Effect */}
      <div className="absolute inset-0 opacity-30">
        <img src="/banner-bg1.jpg" alt="Hero Background" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="flex-1 flex items-center justify-center pt-20">
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.h1 
                className="text-6xl lg:text-7xl font-bold text-irasco-white leading-tight"
              ...
              >
                <motion.button
                  className="px-8 py-4 bg-gradient-energy rounded-xl font-bold text-irasco-midnight hover:scale-105 transition-transform neon-border"
                ...
                <motion.button
                  className="px-8 py-4 glass-strong rounded-xl font-medium text-irasco-white hover:text-irasco-teal transition-colors"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Watch Demo
